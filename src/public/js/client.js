...
document
  ...
  .addEventListener("click", async function () {
    ...
    const msgDesnormalized = normalizr.denormalize(
      msgNormalized.result,
      schemaMensajes,
      msgNormalized.entities
    );
    ...
    let porcentual = parseInt(
      (msgNormalizedLength * 100) / msgDesnormalizedLength
    );
